...
public class Test {
	...
	public static void main(String[] args) {
		...
		req.setStartDeadWood(0);
		req.setStartLivingWood(0);
		req.setAvgWoodGrowth(10);
		req.setAvgDeadWoodYearly(2);
		req.setAvgHarvestYearly(7);
		req.setAvgProcessedWoodYearly(0.8);
	...
	public boolean testOneYear() {
		...
		rec1.setTotalDeadWood(10.0 * 0.8 + 2);
		rec1.setTotalHarvestedWood(10 - 0.5 * 10);
		rec1.setTotalLivingWood(20 - 10 - 2);
	...
	// blackbox test of calculations in simulator in order to verify if the simulator works according to specification
	public boolean testFourYears() {
		SimulationRequest req = new SimulationRequest();
		req.setStartDeadWood(15);
		req.setStartLivingWood(30);
		req.setAvgWoodGrowth(8);
		req.setAvgProcessedWoodYearly(0.5);
		req.setAvgHarvestYearly(1);
		req.setAvgDecompWoodYearly(0.5);
		req.setAvgDeadWoodYearly(2);

		SimulationResult actual = this.sim.simulate(req, 4);

		// reference result
		SimulationResult expected = new SimulationResult(4);
		...
		SimulationResult.SimulationRecord rec1 = expected.new SimulationRecord();
		rec1.setTotalDeadWood((rec.getTotalDeadWood() * (1 - req.getAvgDecompWoodYearly()) + req.getAvgDeadWoodYearly()));
		rec1.setTotalHarvestedWood(rec.getTotalHarvestedWood() + (req.getAvgHarvestYearly() * (1 - req.getAvgProcessedWoodYearly())));
		rec1.setTotalLivingWood(rec.getTotalLivingWood() + req.getAvgWoodGrowth() - req.getAvgDeadWoodYearly() - req.getAvgHarvestYearly());
		rec1.setTotalProcessedWood(rec.getTotalProcessedWood() + req.getAvgHarvestYearly() * req.getAvgProcessedWoodYearly());
		rec1.setTotalBoundCO2(rec1.getTotalLivingWood() + rec1.getTotalDeadWood()
				+ rec1.getTotalHarvestedWood());
		expected.addSimulationRecordForYear(rec1, 1);
		
		SimulationResult.SimulationRecord rec2 = expected.new SimulationRecord();
		rec2.setTotalDeadWood((rec1.getTotalDeadWood() * (1 - req.getAvgDecompWoodYearly()) + req.getAvgDeadWoodYearly()));
		rec2.setTotalHarvestedWood(rec1.getTotalHarvestedWood() + (req.getAvgHarvestYearly() * (1 - req.getAvgProcessedWoodYearly())));
		rec2.setTotalLivingWood(rec1.getTotalLivingWood() + req.getAvgWoodGrowth() - req.getAvgDeadWoodYearly() - req.getAvgHarvestYearly());
		rec2.setTotalProcessedWood(rec1.getTotalProcessedWood() + req.getAvgHarvestYearly() * req.getAvgProcessedWoodYearly());
		...
		rec3.setTotalDeadWood((rec2.getTotalDeadWood() * (1 - req.getAvgDecompWoodYearly()) + req.getAvgDeadWoodYearly()));
		rec3.setTotalHarvestedWood(rec2.getTotalHarvestedWood() + (req.getAvgHarvestYearly() * (1 - req.getAvgProcessedWoodYearly())));
		rec3.setTotalLivingWood(rec2.getTotalLivingWood() + req.getAvgWoodGrowth() - req.getAvgDeadWoodYearly() - req.getAvgHarvestYearly());
		rec3.setTotalProcessedWood(rec2.getTotalProcessedWood() + req.getAvgHarvestYearly() * req.getAvgProcessedWoodYearly());
		...
		rec4.setTotalDeadWood((rec3.getTotalDeadWood() * (1 - req.getAvgDecompWoodYearly()) + req.getAvgDeadWoodYearly()));
		rec4.setTotalHarvestedWood(rec3.getTotalHarvestedWood() + (req.getAvgHarvestYearly() * (1 - req.getAvgProcessedWoodYearly())));
		rec4.setTotalLivingWood(rec3.getTotalLivingWood() + req.getAvgWoodGrowth() - req.getAvgDeadWoodYearly() - req.getAvgHarvestYearly());
		rec4.setTotalProcessedWood(rec3.getTotalProcessedWood() + req.getAvgHarvestYearly() * req.getAvgProcessedWoodYearly());
	...
	private static boolean compareRecords(SimulationResult.SimulationRecord actual,
